...
class Catan:
    def __init__(self,player1,player2,mode,screen,GameSelected,Resign,CommonWC,UpdateCSV,movearray):
        ...
        self.settlement_imgs = {
            1: pygame.transform.scale(pygame.image.load("settlement_p1.png").convert_alpha(), (30, 30)),
            2: pygame.transform.scale(pygame.image.load("settlement_p2.png").convert_alpha(), (30, 30))
        }

        self.road_imgs = {
            1: pygame.transform.scale(pygame.image.load("road_p1.png").convert_alpha(), (40, 10)),
            2: pygame.transform.scale(pygame.image.load("road_p2.png").convert_alpha(), (40, 10))
        }

        self.robber_img = pygame.transform.scale(pygame.image.load("robber.png").convert_alpha(), (40, 40))
